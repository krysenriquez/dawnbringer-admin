...
import {useBranchesListQueryContext} from '../../stores/BranchesListQueryProvider'
...
const BranchCreateForm = () => {
  ...
  const {refetch} = useBranchesListQueryContext()
      ...
      {(actions) => (
        <Form id={formId} className='form'>
          <div className='d-flex flex-column scroll-y me-n7 pe-4'>
            ...
            <div className='row mb-7'>
              <div className='col-6'>
                <InputField className='form-control' name={address1.name} label={address1.label} />
              </div>
              <div className='col-6'>
                <InputField className='form-control' name={address2.name} label={address2.label} />
              </div>
            </div>
            <div className='row mb-7'>
              <div className='col-6'>
            ...
            <div className='row mb-7'>
              <div className='col-6'>
                <InputField className='form-control' name={province.name} label={province.label} />
              </div>
              <div className='col-6'>
                <InputField className='form-control' name={country.name} label={country.label} />
              </div>
            </div>
            <div className='row mb-7'>
              <div className='col-6'>
